...
- **A lenda de Baeshra** (fonte: texto original da Renata no doc "Renata - Lucan Saltbreaker"; cronologia DM): nasceu **Ssarik-Ro**, no **clã Ro**, lizardfolk caçadores-recolectores do Pântano do Véu-Quebrado, na vila que hoje é o **Sunken Boneyard**. Aos 7, estava numa floresta vizinha na Prova da Força (caçar um urso sozinho) quando **um destacamento Kryn liderado pelo jovem oficial drow Duarte Mirim** (hoje Intendente de Jigau, 142 anos) atacou a vila: a maioria enjaulada e levada, os defensores chacinados — sem follow-up no presente. Voltou e encontrou a vila dizimada e queimada: "a porta a que chegou tarde". **Ficou meses** entre os mortos e, antes de partir, fez **um altar de criança à lenda do seu povo**: o Grande Devorador era uma lenda de um apocalipse futuro que o clã contava, e ele decidiu ser essa entidade. Depois: vilas humanas, um braço cortado por levar uma metáfora à letra, prisão, evasão; **esclavagistas em Jorhas** venderam-no a uma arena — 8 anos de gladiador em Asarius (dos 11 aos 19); Zealot pela fé em si e pelos fãs; aos 33, numa masmorra de um demilich ao serviço de Vecna, o wish. **Ataque há ~50 anos; deus há ~20.** "É só Baeshra"; Sess'inek (o demónio do clã que ocupou o Boneyard depois) não tem nada a ver com ele.
- **O Sunken Boneyard (B3), enriquecido**: os crânios afundados são **as irmãs mortas do Guardião do Musgo** — o cemitério das tartarugas-do-horizonte; a vila do clã Ro ficava em cima deles; depois, o clã de **Skr'a S'orsk** (Sess'inek) viveu em cima de ossos de outra gente. **Skr'a morreu na sessão 1; os restantes dispersaram; o Boneyard não tem dono.** O que já lá está, para a mesa encontrar: **o altar de criança** — um crânio de lizardfolk com chifres esculpido em osso de tartaruga (a imagem do Grande Devorador que o clã esculpia), um dente de leite, uma escama branca, o nome **Ssarik-Ro gravado e riscado, e por baixo "Baeshra"** — o ritual em que assumiu a lenda —, e **a adaga drow incrustada de Duarte Mirim**, deixada como primeira oferenda de sangue. Os de Sess'inek nunca lhe tocaram. Ninguém risca símbolos; tudo é obra de uma criança de 7 anos há 50 anos.
- **A ligação faz-se em três camadas**: o Lucan reconhece os chifres (sabe como o deus é, pela estátua); o **Morgid** conta a história; e a voz de Baeshra cala-se ou diz "aqui não" — a primeira vez que o Lucan vê o deus ter medo ou vergonha de um sítio. **Ao pegar na adaga, Baeshra quer vingança** — sobre Duarte Mirim e, por arrasto, sobre líderes da Dinastia: o duelo de Jigau ganha um segundo alvo possível, e a mesa deve favores ao intendente.
- **Morgid é lizardfolk, homem** (retcon ao livro: hobgoblin → lizardfolk), nascido em Urzin, guia do prólogo. O pai, **Hesskar-Ro**, é o **único sobrevivente do clã Ro**, vivo, velho (70+), em Urzin: o único que conheceu o rapaz; sabe o nome de nascimento. Não viu o altar ser feito — encontrou-o anos depois, numa volta à vila, e percebeu quem o fez pelo nome riscado; só soube no que o rapaz se tornou ao ouvir o nome numa história de gladiadores. A frase da sessão 1 ("o pai do Morgid fazia parte do clã que encontraram") fica verdadeira: o clã que encontraram é o extinto — os ossos são dele.
