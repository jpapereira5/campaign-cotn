...
- **A corte de Sess'inek no ossário** (o que o clã de Skr'a lá deixou): não era um bando, era uma **corte**. O Emperor Lizard é o demon lord que dá aos lizardfolk o que eles nunca tiveram — tronos, coroas, escalões — e o clã montou isso **em cima de um cemitério**: o maior crânio de tartaruga, raspado e polido por dentro, serve de **trono** virado para o pântano; os restantes estão arrumados à volta **por ordem de posto** (de longe parece despejo; Investigation dá a hierarquia); em cada um, gravados no osso e nunca pintados, **seis riscos paralelos** — as seis mãos do senhor deles —, que se repetem em escamas soltas, cabos de lança e na testa do próprio Skr'a. **O trono está vazio desde a sessão 1 e continua limpo**: um dos que fugiram há-de voltar para o ocupar, muito depois de o grupo sair do pântano e **sem contas a ajustar com eles** — é o que acontece ao sítio, não um NPC de mesa. O **altar do Baeshra fica a três metros do trono e nunca foi tocado**: é isto o "medo" — uma corte do domínio não sabe o que fazer com um santuário a um Devorador. **Os seis riscos são a semente**: reaparecem, à escala errada, dentro do Betrayers' Rise (cap. 3), e são a paga de ter investigado um sítio que não era preciso investigar. Ver `docs/lore.md` para o canon.
